...
## Initializing the Sklearn processor for processing step 
...
##Hard coded the input path for the data preprocessing
...
## Processing step will take the data and perform the preprocessing 
...
## Pipeline workflow will create the pipeline 
